...
class SymmetricCipher {
 public:
    ...
    virtual bool Encrypt(
        const Byte* plain_text, const size_t plain_text_size, Bytes* cipher_text, size_t& cipher_text_size) const = 0;
    ...
    virtual bool Decrypt(
        const Byte* cipher_text, const size_t cipher_text_size, Bytes* plain_text, size_t& plain_text_size) const = 0;
...
class Hasher {
 public:
    ...
    virtual bool GetHash(
        Byte* hash_text, const size_t cipher_text_size, Bytes* plain_text, size_t& hash_size) const = 0;
    // Resets
...
class SecurityFactory {
    ...
    virtual SymmetricCipher* CreateSymmetricCipher(const SymmetricKey* key = nullptr,
        const SymmetricCipher::Mode mode = SymmetricCipher::ECB, const Bytes& iv) const = 0;
