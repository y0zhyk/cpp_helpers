...
// The SymmetricCipher interface represents the functionality of a cryptographic cipher used for encryption and decryption
...
// The SymmetricKey interface represents the functionality of a cryptographic key used for encryption and decryption.
class SymmetricKey {
...
class SecurityFactory {
    ...
    virtual SymmetricKey* CreateSymmetricKey(const Byte* key_data, const size_t size) const = 0;
    // Creates a symmetric cipher with given parametrs
    virtual SymmetricCipher* CreateSymmetricCipher(const SymmetricKey* key = nullptr,
